                ...
                </Pressable>
                {
                    props.gameState !== "IN_PROGRESS" ?
                        <Pressable onPress={() => { props.toggleResultsOverlay() }}>
                            <Ionicons name="trophy-sharp" size={40} color={props.theme === 'light' ? ColorSchemes.light.textColor : ColorSchemes.dark.textColor} />
                        </Pressable> : null
                }
                <Pressable onPress={() => { props.toggleSettingsOverlay(true) }}>
                    <Ionicons name="settings" size={40} color={props.theme === 'light' ? ColorSchemes.light.textColor : ColorSchemes.dark.textColor} />
                </Pressable>
            </View>
        </View>
    )
